...
public class PaperDaoImpl extends BaseDao implements PaperDao {
	...
	public int addPapers(Paper paper) {
		...
		doOperate(sql, paper.getPaperId(),paper.getUserId(),paper.getPaperTitle(),
		paper.getPaperSummary(),paper.getPaperStartDate(),paper.getPaperEndDate(),paper.getPaperBg(),
		paper.getPaperType(),paper.getPaperStatus(),paper.getPaperCount());
		closeAll();
